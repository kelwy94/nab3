...
class _InvestorHomeTabState extends State<InvestorHomeTab> {
                ...
                children: [
                  _buildActionCard(
                    ...
                    () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (_) => const AssetManagementScreen())),
                  ),
                  ...
                  _buildActionCard(
                    ...
                    () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (_) => const MarketReportsScreen())),
                  ),
                ],
              ),
            ],
          ...
          : Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    _buildStatItem(
                        _activeAssetsCount > 0 ? '+12.4%' : '0.0%',
                        'نمو سنوي',
                        _activeAssetsCount > 0
                            ? Colors.greenAccent
                            : Colors.grey.shade300),
                    const SizedBox(width: 24),
                    _buildStatItem(
                        '$_activeAssetsCount', 'أصول نشطة', Colors.white),
                  ],
                ),
              ],
            ),
  ...
  Widget _buildInvestmentChance(
      String title, String loc, String roi, Color color) {
    return NabaCard(
      ...
      onTap: () {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content: Text(
                  'قريباً: عرض التفاصيل الكاملة للمشروع وإتمام ضخ الأموال.')),
        );
      },
      child: Row(
...
class InvestorProjectsTab extends StatelessWidget {
                ...
                Expanded(
                  child: _buildProjectAction(
                    ...
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (_) => const RequestWorkerScreen())),
                  ),
                ),
              ],
            ),
  ...
  Widget _buildProjectCard(BuildContext context, String title, String status,
